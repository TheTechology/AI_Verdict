...
const SYSTEM_PROMPT = `Ești motorul de analiză al platformei VERITAS AI, un instrument de alfabetizare media care ajută cetățenii să evalueze conținut informațional.
